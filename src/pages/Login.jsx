    ...
    return(
        <div className="bg-black p-10">
            <div className="bg-[#EFEFEF] p-10 border rounded-md">
                ...
                {ruser? <p>I help to manage your activities after you login :)</p> : <p className="text-red-500">Please sign up before you login! </p>}
                ...
                <div className="flex flex-col gap-2 my-2">
                    ...
                    <button className="bg-[#8272DA] w-24 p-1 rounded-md" onClick={chechUser}>
                        Login
                    </button>
